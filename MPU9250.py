...
stopTime = 26
tempo_parado = 3 # keep still 3 seconds to average acc magnitude
mag_enabled = False
...
print('Calculated Threshold = %.4f + 2 * %.4f = %.4f' % (np.mean(stationaty_start_time),
                                                     np.std(stationaty_start_time),
                                                     statistical_stationary_threshold))
print('Fixed Threshold = %.4f' % (stationary_threshold))
